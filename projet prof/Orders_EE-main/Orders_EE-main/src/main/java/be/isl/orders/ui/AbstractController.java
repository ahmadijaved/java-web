...
import be.isl.orders.business.AbstractFacade;
import be.isl.orders.entity.AbstractEntity;
...
public abstract class AbstractController<T extends AbstractEntity, 
    ...
    public DataModel getItems() {
        if (items == null) {
            items = new ListDataModel(getFacade().findVM(getSearch()));
